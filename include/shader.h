...
// Feature 3/4: Geometry term for area light sampling.
// G = |cos(light_normal, -wi)| / r^2 — converts area-measure PDF to solid-angle PDF.
                        ...
                        const Triangle* triangles)
{
    ...
    // Emission is handled in TraceRayIterative so the NEE modes stay comparable.
